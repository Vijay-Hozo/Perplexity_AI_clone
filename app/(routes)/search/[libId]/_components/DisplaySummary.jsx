    ...
    <div className="mt-7">
      <ReactMarkdown
        components={{
          ...
          h2: ({ node, ...props }) => (
            <h2 className="text-3xl font-semibold text-gray-800 mb-3" {...props} />
          ),
          h3: ({ node, ...props }) => (
            <h3 className="text-2xl font-semibold text-gray-700 mb-2" {...props} />
          ),
          p: ({ node, ...props }) => (
            <p className="text-gray-700 leading-relaxed mb-2" {...props} />
          ),
          ul: ({ node, ...props }) => (
            <ul className="list-disc list-inside mb-4 pl-4 text-gray-700" {...props} />
          ),
          li: ({ node, ...props }) => (
